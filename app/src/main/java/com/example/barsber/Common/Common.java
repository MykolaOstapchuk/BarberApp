...
public class Common {
    ...
    public static final String KEY_DAY_LOAD_DONE = "DAY_LOAD_DONE";
    public static final Object DISABLE_TAG = "DISABLE_TAG" ;
    public static final String KEY_TIME_SLOT = "TIME_SLOT";
    public static final String KEY_CONFIRM_BOOKING = "CONFIRM_BOOKING";
    public static final String KEY_TIME_STRING = "KEY_TIME_STRING";
    public static final String WEEKEND_LOAD_DONE ="WEEKEND_LOAD_DONE" ;
    ...
    public static int dayFromServer=0;
    public static boolean reloadCalendar =false;
    public static boolean firstTimeLoadCalendar = true;
    //
    public static boolean test =false;
    public static boolean testBarber=false;
    public static boolean testTimeSlot=false;
    public static boolean date1 =false;
    public static boolean date2 =false;
    public static int currentTimeSlot = -1;
    public static String currentTimeSlotString = "";
